    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body" style="margin-left: 120px;">
                ...
                <button type="button" id="btn-filter" class="btn btn-success" onclick="onSalesOrderFilterButtonClick()">
                    Generate Report
                </button>
            </div>
        </div>
...
<script>
    ...
    function onSalesOrderFilterButtonClick() {
    ...
    function generateReport() {
        $.ajax({
            type: "post",
            url: $('#baseUrl2').val() + 'report/report/sales_order_reportinvoicewise',
            data: {
            ...
            success: function(data1) {
                ...
                if (datas.length > 0) {
                    window.open('generate_salesorderreportinvoice', '_blank');
                } else {
